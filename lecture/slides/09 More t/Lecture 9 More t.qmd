...
-   The observations are independent
    -   [Make sure no datapoints come from the same person or clusters that are somehow related. Repeated measures methods (will discuss later) or multilevel models (beyond scope of course) can help address independence violations]{.answer .fragment .content-visible unless-meta="params.v0"}
