...
You work at a car dealership that sells on average ten cars in a given week. What is the probability you sell one or fewer cars in a given week?
...
[$P(x > 1) = 1 - .80 = .20$]{.answer .fragment .content-visible unless-meta="params.v0"}
