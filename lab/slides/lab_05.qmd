...
<div class="subpoint">○ `var.equal = T`: tells `R` *not* to use the Welch-Satterthwaite correction  </div>

<div class="subsubpoint">○ for demonstration. Generally, we can leave it to its default (if you don't specify `var.equal = T`, it will default to `var.equal = F`! </div>
