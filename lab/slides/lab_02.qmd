...
[**Import**]{style="color:#051E39"} <span style="color: #C5C5C5;"> → Tidy → Transform → Visualize → Model → Communicate</span>
...
read.csv(here::here("lab", "data", "lab_02", "world_cup_player_stats.csv")) |>
  tibble::tibble() |>
  head(5) |>
  gt::gt()
```
...
::: callout-note
I found this dataset on [Kaggle](https://www.kaggle.com/){preview-link="true"}, a website where people can share datasets (real or simulated). Helpful place to look for interesting datasets!
:::
...
You can access the data through our [class GitHub source page](https://github.com/jhelmer3/PSYC6019-2026){target="blank"}
...
Read more about why at this post on [Project-Based Workflow](https://tidyverse.org/blog/2017/12/workflow-vs-script/){target="blank"}.
...
::: footer
[What They Forgot to Teach You About R](https://rstats.wtf/practice-safe-paths){target="blank"}, [Ode to the `here` Package](https://github.com/jennybc/here_here){target="blank"}
:::
...
[`here::here("media", "results.png")`]{.fragment}
:::
::::
...
::: fragment
```{r}
here::here("lab", "data", "lab 02", "world_cup_player_stats.csv")
```
:::

::: fragment
```{r}
head(read.csv(here::here("lab", "data", "lab_02", "world_cup_player_stats.csv")), 2)
```
...
<span style="color: #C5C5C5;">Import → </span>[**Tidy**]{style="color: #051E39"}<span style="color: #C5C5C5;"> → Transform → Visualize → Model → Communicate</span>
...
<span style="color: #C5C5C5;">Import → Tidy → </span>[**Transform**]{style="color: #051E39"}<span style="color: #C5C5C5;"> → Visualize → Model → Communicate</span>
...
![Datasaurus Dozen](../media/lab_02/datasaurus.png){height=500 fig-align="center" target="blank"}

::: footer
[research.autodesk.com/publications/same-stats-different-graphs](https://www.research.autodesk.com/publications/same-stats-different-graphs/){target="blank"}
:::
...
[`tidyverse` documentation with all geoms](https://ggplot2.tidyverse.org/reference/){target = "blank"}
:::
...
[List of `ggplot` themes](https://ggplot2.tidyverse.org/reference/ggtheme.html){target="blank"}
...
[Documentation for everything you can do with the `theme()` function](https://ggplot2.tidyverse.org/reference/theme.html){target="blank"}
